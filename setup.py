...
cc_libs = CcLibraries([
    ...
    CcLibrary("cc/particle_mesh/distribution_functions.h",
              deps=[
                  "cc/types",
                  "cc/array/row_major_array",
              ]),
    CcLibrary("cc/particle_mesh/mass_assignor.h",
              deps=[
                  ...
                  "cc/particle_mesh/distribution_functions",
                  "cc/profiling/timer",
              ]),
...
cython_libs = CythonLibraries([
    ...
    CythonLibrary("fftcorr.particle_mesh.distribution_scheme",
                  pxd_file="fftcorr/particle_mesh/distribution_scheme.pxd",
                  cc_deps=["cc/particle_mesh/distribution_functions"]),
    CythonLibrary("fftcorr.particle_mesh.mass_assignor",
                  ...
                  pyx_deps=[
                      ...
                      "fftcorr.particle_mesh.distribution_scheme",
